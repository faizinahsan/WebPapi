...
class ProposalPKM(models.Model):
    ...
    idKategori = models.ForeignKey(
        'KategoriPKM', on_delete=models.CASCADE, default=1)
    idBidang = models.ForeignKey(
        'BidangPKM', on_delete=models.CASCADE, default=1)
    idStatus = models.ForeignKey(
        'StatusRevisi', on_delete=models.CASCADE, default=1)
    idFakultas = models.ForeignKey(
